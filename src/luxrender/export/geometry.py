...
class GeometryExporter(object):
	...
	def buildMesh(self, obj):
		...
		if obj.luxrender_object.append_external_mesh:
			...
			if self.allow_instancing(obj) and self.ExportedMeshes.have(ply_mesh_name):
				...
				mesh_definition = (ply_mesh_name, obj.active_material, 'plymesh', obj.data.luxrender_mesh.get_shape_IsSupport(), ply_params)
	...
	def exportShapeDefinition(self, obj, mesh_definition):
		...
		me_name, me_mat, me_shape_type, me_shape_IsSupport, me_shape_params = mesh_definition
	...
	def exportShapeInstances(self, obj, mesh_definitions, matrix=None):
		...
		for me_name, me_mat, me_shape_type, me_shape_IsSupport, me_shape_params in mesh_definitions:
